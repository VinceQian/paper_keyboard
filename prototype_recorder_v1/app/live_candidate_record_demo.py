...
def main() -> None:
    ...
    recorder = DemoRecorder(
        ...
        notes="Live demo recording with board tracking and hand tracking.",
    )
    ...
    try:
        while True:
            ...
            draw_status(
                ...
                recorded_frames=len(recorder.frames),
            )
...
def draw_status(
    ...
    record_text = (
        f"Recording: {recording_enabled} | frames={recorded_frames} | "
        f"space toggle | s save"
    )
